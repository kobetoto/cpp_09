...
void do_the_math(std::stack<long long> &r1, std::stack<long long> &r2, char c)
{
        if (r1.empty() || r2.empty())
                error("wrong expression(0)");
        else
        {
                long long num_r1 = r1.top();
                long long num_r2 = r2.top();
...
void    loading_second_number(long long operand, std::stack<long long> &r1, std::stack<long long> &r2){

        //push top of r1 to r2 & operand to r1
        if(!(r1.empty()))
        {
                r2.push(r1.top());
                r1.pop();
...
{
        std::stack<long long> r1;
        std::stack<long long> r2;
